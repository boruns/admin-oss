(function(){
    ...
    // 图片上传
    window.init_upload = function(id, multi, token, maxFileSize = '10mb', fileExtensions = 'jpg,jpeg,gif,png'){
        var element = $('#'+id);
    ...
    // 编辑器图片上传
    window.init_upload_edit = function(editor, token, maxFileSize = '10mb', fileExtensions = 'jpg,jpeg,gif,png'){
